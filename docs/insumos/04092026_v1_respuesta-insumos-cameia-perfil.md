...
- **Versión:** 1.1
- **Fecha:** 4 de septiembre de 2026, actualizada el 5 de septiembre de 2026
...
>
> **Actualización del 5 de septiembre:** el trabajo ya está publicado en la rama
> `CM-102-base-tecnica`, rebasada sobre el `develop` actual. La convención de nombre de rama
> quedó resuelta por el equipo en `CM-<numero>-<descripcion>`
> ([PR #2](https://github.com/Forkthec/cameia-perfil/pull/2), commit `22aa21d`).
...
Enlaces a PR, commit o documentos:
  Rama CM-102-base-tecnica publicada en origin. PR pendiente de abrir.
```
...
|---|---|---|---|
| 1 | ~~Convención de rama contradictoria~~ **RESUELTO el 5-sep-2026**: el equipo la unificó en `CM-<numero>-<descripcion>` ([PR #2](https://github.com/Forkthec/cameia-perfil/pull/2)). **Pero la estrategia de branching, `github.txt` y las reglas de código §5.8 y §14 todavía dicen `CA` y hay que actualizarlas** | Ya no bloquea publicar. Riesgo de que alguien cite la fuente vieja | Arquitectura |
